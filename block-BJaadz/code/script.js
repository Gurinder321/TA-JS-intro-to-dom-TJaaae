...
document
  ...
  .forEach((elm) => (elm.style.border = "2px solid purple"));
...
// Create a paragraph element and store it in variable named 'para' using `createElement`
...
para.innerText =
  "querySelector returns an element you can manipulate but querySelectorAll returns thecollection of elements in array kind of structure";
...
imgElm.src =
  "https://images.unsplash.com/photo-1638115275995-18fb07309128?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw1fHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=400&q=60";

// Select the box 7 using class seven
let box7 = document.querySelector(".seven");
// Remove all the elements from box seven
box7.innerHTML = "";
...
anchorOne.href = "https://google.com";
anchorTwo.href = "https://altcampus.school";
// Append both the elements to box 5 you selected above.
box5.append(anchorOne);
box5.append(anchorTwo);
